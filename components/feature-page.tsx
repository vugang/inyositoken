        ...
        <Card className="bg-indigo-600 text-white md:col-span-2">
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { name: 'Presale', percentage: 40, color: 'bg-yellow-400' },
                { name: 'Liquidity', percentage: 20, color: 'bg-green-400' },
                { name: 'Team', percentage: 15, color: 'bg-red-400' },
                { name: 'Marketing', percentage: 10, color: 'bg-purple-400' },
                { name: 'Community Incentives', percentage: 15, color: 'bg-pink-400' },
                ...
                <div key={index}>
                  ...
                  <div className="w-full bg-indigo-300 rounded-full h-2 sm:h-3">
                    <div className={`${item.color} h-2 sm:h-3 rounded-full`} style={{ width: `${item.percentage}%` }}></div>
                  </div>
                </div>
              ))}
            </div>
